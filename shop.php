...
<style>
    ...
    <div class="container" style="width: 80%">
        ...
        <?php
            $query = "SELECT * FROM fruits WHERE itemType='Vegetables' ORDER BY id ASC ";
    ...
    <br><br><div class="container" style="width: 80%">
        
        <h1  class="btn-grad"> Fruits</h1><br><br><br>
        <?php
            $query = "SELECT * FROM fruits  WHERE itemType='Fruits' ORDER BY id ASC ";
            $result = mysqli_query($con,$query);
            if(mysqli_num_rows($result) > 0) {
    ...
    <br><br><div class="container" style="width: 80%">
        ...
        <?php
            $query = "SELECT * FROM fruits   WHERE itemType='Leaves'ORDER BY id ASC ";
            $result = mysqli_query($con,$query);
            if(mysqli_num_rows($result) > 0) {
